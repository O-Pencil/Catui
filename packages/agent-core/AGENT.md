...
Member List
agent.ts: Agent class, AgentOptions, AgentLoopPolicyOptions, main agent with message loop, coordinates with agent-loop for execution, stores last run result, runtime-settable loop policy plumbing
...
types.ts: AgentLoopConfig, AgentRunResult, AgentRunPolicy, CustomAgentMessages, AgentState, AgentToolResult, AgentTool, loop limits/budgets, agent-related type definitions, foundational for all modules
