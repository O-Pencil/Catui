...
structured-adaptive-agent-loop.ts: structuredAdaptiveAgentLoop and structuredAdaptiveAgentLoopContinue, low-intelligence adaptation loop with ordered tool results and concurrency-safe tool batching
structured-adaptive-tool-orchestration.ts: runStructuredAdaptiveTools and partitionStructuredAdaptiveToolCalls, low-intelligence adaptation tool batching/execution layer with ordered tool_result pairing
