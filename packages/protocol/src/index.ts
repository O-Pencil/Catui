 ...
 * [FROM]: Re-exports the per-protocol modules (tools + lifecycle + commands + hooks today; themes/permissions in later P3 checkpoints)
 ...
 * commands, hooks, then themes/permissions. Explicitly NOT here (EVOLUTION-RESERVED): agent-profile,
