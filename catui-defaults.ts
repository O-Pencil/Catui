	...
	providers: {
		...
		[CATUI_ALI_TOKEN_PLAN_OPENAI_PROVIDER]: {
			...
			models: [
				...
				{
					id: "qwen3.8-flash",
					name: "Qwen3.8 Flash (Ali Token Plan OpenAI)",
					reasoning: true,
					input: ["text", "image"],
					compat: {
						supportsStore: false,
				...
				},
				{
					...
					name: "Qwen Image 3.0 Pro (Ali Token Plan OpenAI)",
					reasoning: false,
					input: ["text"],
					compat: {
						supportsStore: false,
				...
				},
				{
					...
					name: "Qwen Audio 3.0 TTS Plus (Ali Token Plan OpenAI)",
					reasoning: false,
					input: ["text"],
					compat: {
						supportsStore: false,
				...
				},
				{
					...
					name: "HappyHorse 1.1 T2V (Ali Token Plan OpenAI)",
					reasoning: false,
					input: ["text"],
					compat: {
						supportsStore: false,
				...
				},
				{
					...
					name: "DeepSeek V4 Pro 0813 (Ali Token Plan OpenAI)",
					reasoning: true,
					input: ["text"],
					compat: {
						supportsStore: false,
				...
				},
				{
					...
					name: "DeepSeek V4 Flash 0731 (Ali Token Plan OpenAI)",
					reasoning: true,
					input: ["text"],
					compat: {
						supportsStore: false,
		...
		[CATUI_ALI_TOKEN_PLAN_ANTHROPIC_PROVIDER]: {
			...
			models: [
				...
				{
					id: "qwen3.8-flash",
					name: "Qwen3.8 Flash (Ali Token Plan Anthropic)",
					reasoning: true,
					input: ["text", "image"],
					contextWindow: 1000000,
					maxTokens: 65536,
				...
				{
					id: "deepseek-v4-pro-0813",
					name: "DeepSeek V4 Pro 0813 (Ali Token Plan Anthropic)",
					reasoning: true,
					input: ["text"],
					contextWindow: 262144,
					maxTokens: 65536,
				...
				{
					id: "deepseek-v4-flash-0731",
					name: "DeepSeek V4 Flash 0731 (Ali Token Plan Anthropic)",
					reasoning: true,
					input: ["text"],
					contextWindow: 262144,
					maxTokens: 65536,
				...
				{
					id: "deepseek-v4-pro",
					name: "DeepSeek V4 Pro (Ali Token Plan Anthropic)",
					reasoning: true,
					input: ["text"],
					contextWindow: 262144,
					maxTokens: 65536,
				...
				{
					id: "glm-5.2",
					name: "GLM-5.2 (Ali Token Plan Anthropic)",
					reasoning: true,
					input: ["text"],
					contextWindow: 202752,
					maxTokens: 16384,
