 ...
 * [TO]: Consumed by index.ts, main.ts, modes/interactive/interactive-mode.ts, extensions/builtin/team/index.ts, and test files
 * [HERE]: core/platform/config/resource-loader.ts - discovers and loads extensions, skills, themes
 */
...
import { createExtensionRuntime, loadExtensionFromFactory, loadExtensions } from "../../extensions-host/loader.js";
import type { Extension, ExtensionFactory, ExtensionRuntime, LoadExtensionsResult } from "../../extensions-host/types.js";
...
export class DefaultResourceLoader implements ResourceLoader {
	...
	async reload(): Promise<void> {
		...
		const personaSkillsDir =
			personaId && existsSync(getPersonaSkillsDir(personaId)) ? getPersonaSkillsDir(personaId) : undefined;
