 ...
 * [TO]: Consumed by core/model-registry.ts, core/platform/config/auth-storage.ts
 * [HERE]: core/platform/config/resolve-config-value.ts - resolve config values (shell, env, literal)
 */
