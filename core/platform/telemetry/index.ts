 ...
 * [TO]: Consumed by extensions/builtin/sal/* and (future) extensions/<ext>/telemetry sinks via `import { ... } from "../../../core/platform/telemetry/index.js"`
 * [HERE]: core/platform/telemetry/index.ts - barrel for the telemetry module; the only entry point external callers should import from
 */
