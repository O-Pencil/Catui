 ...
 * [TO]: Consumed by extensions/builtin/sal/index.ts via re-export; future extension-telemetry sink reads via the same loader
 * [HERE]: core/platform/telemetry/credentials.ts - parses ~/.memory-experiments/credentials.json (workspace fallback ordered first), accepts both {credentials:[{id,...}]} and flat formats, returns null when no usable file found
 */
