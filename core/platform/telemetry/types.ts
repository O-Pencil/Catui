 ...
 * [TO]: Consumed by core/platform/telemetry/credentials.ts, insforge-base.ts, batching-dispatcher.ts; mirrored by sinks (SAL eval, future extension telemetry)
 * [HERE]: core/platform/telemetry/types.ts - foundational type surface for the telemetry layer; identical diagnostic shape to SAL's onDiagnostic so SAL can adopt without callsite churn
 */
