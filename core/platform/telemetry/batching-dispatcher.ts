 ...
 * [TO]: Consumed by extensions/builtin/sal/eval/insforge-sink.ts via composition; future ext-telemetry sink reuses the same machinery
 * [HERE]: core/platform/telemetry/batching-dispatcher.ts - factored out of SAL's eval sink: SAL's scheduleFlush/doFlush/flush/close logic was inherently generic, now reusable
 */
