 ...
 * [TO]: Consumed by core/tools/bash.ts, core/platform/exec/bash-executor.ts, modes/interactive/components/tool-execution.ts
 * [HERE]: core/platform/utils/shell.ts - shell detection and utilities
 */
