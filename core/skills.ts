...
function loadSkillsFromDirInternal(
	...
	} catch (e) { console.warn("Warning: Failed to read skills directory:", e instanceof Error ? e.message : e); }
...
export interface LoadSkillsOptions {
	...
	cwd?: string;
	/** Agent config directory for global skills. Default: ~/.nanopencil/agent */
	agentDir?: string;
