...
export type { ExecOptions, ExecResult } from "../platform/exec/exec.js";
export type { AgentToolResult, AgentToolUpdateCallback };
export type { AppAction, KeybindingsManager } from "../platform/keybindings.js";
...
export interface ExtensionUIDialogOptions {
	...
	timeout?: number;
	/** Optional initial value shown in the input before editing. */
	initialValue?: string;
}
