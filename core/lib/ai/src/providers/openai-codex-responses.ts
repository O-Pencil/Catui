/**
 * [WHO]: OpenAI Codex Responses API provider
 * [FROM]: Depends on node:os (lazy), openai, env-api-keys, models, types
 * [TO]: Consumed by core/lib/ai/src/index.ts
 * [HERE]: core/lib/ai/src/providers/openai-codex-responses.ts - Codex provider
 */
...
function buildHeaders(
	...
	headers.set("originator", "nanopencil");
	const userAgent = _os ? `nanopencil (${_os.platform()} ${_os.release()}; ${_os.arch()})` : "nanopencil (browser)";
