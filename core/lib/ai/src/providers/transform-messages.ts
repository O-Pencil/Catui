 ...
 * [TO]: Consumed by provider stream implementations and core/lib/ai/src/index.ts
 * [HERE]: core/lib/ai/src/providers/transform-messages.ts - cross-provider message replay normalization
 */
