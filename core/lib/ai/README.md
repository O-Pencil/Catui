...
- **Ali Token Plan** models use either `openai-completions` or `anthropic-messages` through compatible endpoints
...
Add an entry to `core/lib/ai/CHANGELOG.md` under `## [Unreleased]`:
