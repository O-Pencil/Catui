...
/**
 * Base class holding AgentSession's session logic. The exported `AgentSession`
 * composes `SessionSettingsAccessors` for the settings getter/setter surface.
 */
...
/**
 * Public AgentSession: session lifecycle + settings accessor surface.
 * Settings getters/setters live in the SessionSettingsAccessors mixin;
 * session logic lives in AgentSessionBase.
 */
export class AgentSession extends SessionSettingsAccessors(AgentSessionBase) {}
