...
`harness-eval/`: Deterministic manifest runner, isolated/sequential/interleaved contracts, and required offline scripted-model corpus that executes both production agent loops and real tools
