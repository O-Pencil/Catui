...
| in-progress | `slash-dispatcher-controller` | UI02 | skillCommands | 当前切片：只抽 built-in slash command token dispatch + clearEditor 策略；不碰 onSubmit/persona/bash/streaming/attachment input pipeline |
