...
4. **Gate**：切片对照 [gates.md](./gates.md)（UI-G1…UI-G7）。
...
| [UI06](./findings/UI06-input-submit-pipeline.md) | selected | `setupEditorSubmitHandler`(~246 行) 提交管线独立成 `input-submit-controller`；与 slash-dispatcher 边界清晰 |
