...
| 10 ✅ in progress | internal AI import migration | EV05 / Q3 | active | Type-only/models/OAuth slices validated by maintainer build; current slice migrates provider registry imports to `@pencil-agent/ai/registry` |
