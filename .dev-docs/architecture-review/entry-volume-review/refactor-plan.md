...
| 10 ✅ in progress | internal AI import migration | EV05 / Q3 | active | Type-only slice validated by maintainer build; current slice migrates model catalog/helper imports to `@pencil-agent/ai/models` |
