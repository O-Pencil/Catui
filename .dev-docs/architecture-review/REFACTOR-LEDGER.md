...
| P7 体积重设计 | 发布边界硬化 / browser optional / model metadata chunking / esbuild deferred | 🟡 评审已启，代码未启 | bundle-redesign-review（BR01–BR04）|
...
| O7 | **P7/P8（可选）**：P7 已先转专项评审；第一刀建议 BR01 发布边界硬化，非 esbuild | 代码（可选）| — |
