 ...
 * [TO]: Consumed by modes/interactive/components/footer.ts, core/extensions-host/types.ts
 * [HERE]: modes/interactive/footer-data-provider.ts - footer information provider
 */
