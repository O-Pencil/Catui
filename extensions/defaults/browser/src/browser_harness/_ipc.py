...
[WHO]: Provides socket path, process spawn, connect(), serve(), and endpoint cleanup helpers
[FROM]: Depends on asyncio, socket, subprocess, tempfile, pathlib for cross-platform daemon IPC
[TO]: Consumed by browser_harness.daemon, browser_harness.helpers, and browser_harness.admin
[HERE]: extensions/defaults/browser/src/browser_harness/_ipc.py within vendored Browser Harness package
"""
