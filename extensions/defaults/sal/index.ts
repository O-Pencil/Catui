...
// ---------------------------------------------------------------------------
// Build metadata: version + commit hash, resolved once at module load.
// In production (dist/), build-meta.json is generated by build:meta script.
// In dev (tsx), fall back to reading package.json directly.
// ---------------------------------------------------------------------------
interface BuildMeta {
	version: string;
	commitHash?: string;
...
function loadBuildMeta(): BuildMeta {
