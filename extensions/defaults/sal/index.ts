...
import { type BuildMeta, loadBuildMeta, loadInsforgeCredentials } from "../../../core/telemetry/index.js";
...
// Build metadata: version + commit hash + branch, resolved once at module
// load. Sourced from core/telemetry/build-meta so SAL and the new ext-events
// sink stamp every emitted row with the exact same version. See
// core/telemetry/build-meta.ts for the resolution strategy.
