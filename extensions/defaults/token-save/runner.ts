 ...
 * [TO]: Consumed by extensions/defaults/token-save/index.ts and tests
 * [HERE]: extensions/defaults/token-save/runner.ts - TokenSave capture/stream/passthrough result contract
 */
