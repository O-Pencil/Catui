 ...
 * [TO]: Consumed by extensions/defaults/token-save/index.ts
 * [HERE]: extensions/defaults/token-save/config.ts - configurable TokenSave filters with project trust guard
 */
