 ...
 * [HERE]: extensions/defaults/idle-think/thinker.ts - background code exploration via SubAgent
 */
...
function findInternetSearchSkillPath(): string | undefined {
	// Walk up from idle-think/ to extensions/defaults/, then into link-world/
	const candidates = [
