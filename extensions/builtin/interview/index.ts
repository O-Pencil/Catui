 ...
 * [FROM]: Depends on core/extensions-host/types.ts, core/session/session-manager.ts, interview-runtime.ts
 * [TO]: Loaded by core/extensions-host/loader.ts as extension entry point
 * [HERE]: extensions/builtin/interview - requirement clarification extension
 */
