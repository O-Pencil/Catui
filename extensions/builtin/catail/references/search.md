...
- Map consensus, disagreement, method differences, population/system differences, and missing evidence.
...
The search is repeatable from its log, count mismatches and database failures are visible, and the conclusion distinguishes “not found in this bounded search” from “does not exist.”
