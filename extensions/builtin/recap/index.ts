 ...
 * [FROM]: Depends on core/extensions-host/types, ./recap-renderer, ./recap-synthesizer, ./recap-extractor, ./recap-types
 * [TO]: Auto-loaded by builtin-extensions.ts as a default extension
 * [HERE]: extensions/builtin/recap/index.ts - on-demand situational recap; Free (deterministic, zero-token) by default, Smart (LLM-polished) via --smart
 */
