...
// completion gate.
const FORBIDDEN = [
  { marker: 'catpaw-variants-start', why: 'variant wrapper comment left in source' },
  { marker: 'catpaw-variants-end', why: 'variant wrapper comment left in source' },
  { marker: 'catpaw-carbonize-start', why: 'carbonize block not rewritten into permanent form' },
  { marker: 'catpaw-carbonize-end', why: 'carbonize block not rewritten into permanent form' },
  { marker: 'catpaw-param-values', why: 'param-values comment not baked and removed' },
  { marker: 'data-catpaw-', why: 'live-mode plumbing attribute left on markup' },
  ...
  { marker: '--catpaw-variant-ready', why: 'preview readiness sentinel left in CSS' },
];
