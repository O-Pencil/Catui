/**
 * Framework-neutral Catpaw live chrome contract.
 *
...
export const LIVE_UI_SURFACES = Object.freeze([
  {
    ...
    ids: [
      'catpaw-live-global-bar',
      'catpaw-live-global-bar-brand',
      'catpaw-live-pick-toggle',
      'catpaw-live-insert-toggle',
      'catpaw-live-detect-toggle',
      'catpaw-live-detect-badge',
      'catpaw-live-design-toggle',
      'catpaw-live-page-chat',
      'catpaw-live-page-chat-input',
      'catpaw-live-page-chat-voice',
    ],
    states: ['rest', 'hover', 'focus-visible', 'pressed', 'active', 'tooltip'],
  },
  {
    key: 'pending-copy-edit-dock',
    ids: ['catpaw-live-pending-dock'],
    states: ['closed', 'open', 'hover', 'pressed', 'loading', 'rollback', 'keep-fixing'],
  },
  {
    key: 'element-selection-chrome',
    ids: [
      'catpaw-live-highlight',
      'catpaw-live-tooltip',
      'catpaw-live-bar',
      'catpaw-live-selection-pill',
      'catpaw-live-input',
      'catpaw-live-configure-voice',
      'catpaw-live-configure-bar-tooltip',
    ],
    states: ['rest', 'hover', 'focus-visible', 'pressed', 'disabled'],
  },
  {
    key: 'action-picker',
    ids: ['catpaw-live-picker'],
    states: ['closed', 'open', 'option-hover', 'option-focus'],
  },
  {
    key: 'edit-chrome',
    ids: ['catpaw-live-edit-badge'],
    states: ['enabled', 'disabled', 'editing', 'cancel', 'save', 'edited-content'],
  },
  {
    key: 'generating-row',
    ids: ['catpaw-live-bar', 'catpaw-live-shader'],
    states: ['action-label', 'animated-dots', 'generating', 'done'],
  },
  {
    key: 'variant-cycling-row',
    ids: ['catpaw-live-bar', 'catpaw-live-params-panel'],
    states: ['variant-1', 'variant-2', 'variant-3', 'left-disabled', 'right-disabled', 'dot-click', 'accept', 'discard'],
  },
  {
    key: 'variant-params-panel',
    ids: ['catpaw-live-params-panel'],
  ...
  },
  {
    ...
    ids: [
      'catpaw-live-insert-line',
      'catpaw-live-insert-placeholder',
      'catpaw-live-placeholder-resize',
      'catpaw-live-insert-input',
      'catpaw-live-insert-voice',
      'catpaw-live-insert-create',
      'catpaw-live-insert-create-tooltip',
    ],
...
export function resolveLiveUiRoot(env = globalThis) {
  ...
  const explicit = env?.__CATPAW_LIVE_UI_ROOT__
    || env?.window?.__CATPAW_LIVE_UI_ROOT__;
...
export function appendToLiveUiRoot(el, env = globalThis) {
  const root = resolveLiveUiRoot(env);
  if (!root) throw new Error('Catpaw live UI root is not available');
  root.appendChild(el);
  return el;
}
