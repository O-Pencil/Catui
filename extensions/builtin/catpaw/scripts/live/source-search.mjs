 ...
 * session's `catpaw-variants-start` marker). They had two near-identical
...
import { CATPAW_DIR } from '../lib/catpaw-paths.mjs';
 ...
 *
 * `.catpaw` is the critical entry, and it is not cosmetic. Progressive
 * publication stages each revision as `.catpaw/live/artifacts/
 ...
 * hand.
 */
export const NEVER_SOURCE_DIRS = Object.freeze(['node_modules', '.git', CATPAW_DIR]);
