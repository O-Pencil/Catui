#!/usr/bin/env node
/**
 * Context-signals gatherer for the bare Catpaw invocation
 ...
 * light: no LLM calls, no detector run (`npx catpaw detect` is heavier and
 ...
 *   - critique:  the latest cached critique score (.catpaw/critique)
...
import { getCritiqueDir } from './lib/catpaw-paths.mjs';
...
// .catpaw/, issue #303), a build artifact, or a dependency. Mirrors the
