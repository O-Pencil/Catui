...
- **Suggested command**: Which command to use (prefer: $catpaw adapt, $catpaw animate, $catpaw audit, $catpaw bolder, $catpaw clarify, $catpaw colorize, $catpaw critique, $catpaw delight, $catpaw distill, $catpaw document, $catpaw harden, $catpaw layout, $catpaw onboard, $catpaw optimize, $catpaw overdrive, $catpaw polish, $catpaw quieter, $catpaw shape, $catpaw typeset)
