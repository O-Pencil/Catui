 ...
 *
 * This module builds the prompt that instructs the model to:
 * 1. Parse [interval] <prompt> from user input
 * 2. Convert interval to cron expression
 * 3. Call CronCreate
 * 4. Confirm and execute immediately
 */
...
export function getLoopUsageMessage(): string {
