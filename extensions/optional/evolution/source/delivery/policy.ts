 ...
 */
export function repairable(path: string, scope: "source" | "adaptive" = "source"): boolean {
	...
	if (path.startsWith("extensions/optional/evolution/source/")) return scope === "adaptive" && ["extensions/optional/evolution/source/learning/detectors.ts", "extensions/optional/evolution/source/learning/repair-strategy.ts"].includes(path);
